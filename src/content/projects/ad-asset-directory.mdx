...
description: Designed and built an internal brand-operations system to help marketing and operations teams find, manage, and preserve assets across multiple identities.
...
<CaseMeta items={[
  { label: "Role", value: "Product designer and full-stack builder for an internal tool spanning IA, search, admin workflows, theming, and implementation." },
...
<MediaFull
  src="/images/projects/ad-assets/search.png"
