...
image: /images/projects/ad-asset-directory/hero.png
techStack:
  - Astro
  - React
  - TypeScript
...
{/* SCREENSHOT: Hero shot showing the brand selection grid on the home page with all brand cards visible */}
<MediaFull src="/images/projects/ad-asset-directory/hero.png" caption="Brand portal selection grid" />
...
{/* SCREENSHOT: Show a brand portal page (e.g., Asheville Dispensary) with expanded categories showing the asset links */}
<MediaFull src="/images/projects/ad-asset-directory/brand-portal.png" caption="Brand portal with organized asset categories" />
...
{/* SCREENSHOTS: Show 2-3 different brand portals side by side to demonstrate the theming system */}
<MediaThree items={[
  { src: "/images/projects/ad-asset-directory/brand-asheville.png", alt: "Asheville Dispensary portal" },
  { src: "/images/projects/ad-asset-directory/brand-plantbar.png", alt: "Plantbar portal" },
  { src: "/images/projects/ad-asset-directory/brand-nightshade.png", alt: "Nightshade portal" }
]} />
...
<MediaFull src="/images/projects/ad-asset-directory/search.png" caption="Fuzzy search with keyboard navigation and filtering" />
...
<MediaTwo items={[
  { src: "/images/projects/ad-asset-directory/admin-dashboard.png", caption: "Admin dashboard overview" },
  { src: "/images/projects/ad-asset-directory/admin-form.png", caption: "Asset link editing form" }
]} />
