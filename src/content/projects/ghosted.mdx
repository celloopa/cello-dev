...
highlights:
  ...
  - Built multi-agent pipeline for automated resume and cover letter generation with scoring
  - Added job board integration fetching postings from Lever, Greenhouse, Workday, and LinkedIn
