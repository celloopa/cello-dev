...
<MediaFull
  ...
  alt="Application detail view showing contacts, interviews, and document links"
  caption="Comprehensive tracking: salary, contacts, interviews, and linked documents"
/>
...
<MediaFull
  ...
  alt="Multi-agent pipeline running with resume and cover letter generation"
  caption="Agent pipeline: parsing, generating, and scoring documents automatically"
/>
...
<MediaFull
  src="/images/projects/ghosted/ghosted-fetch.webm"
  alt="Fetching a job posting from a career page"
  caption="Auto-fetch: extracting job details from Lever, Greenhouse, and more"
/>
...
<MediaFull
  src="/images/projects/ghosted/ghosted-compile.webm"
  alt="Compiling Typst documents to PDFs with smart naming"
  caption="Document compilation: Typst to PDF with automatic naming conventions"
/>
